...
def main(args):
    ...
    train_dataloader,test_dataloader=create_dataloaders(dataset_path="/home/exx/datasets/diffusion-cassini/mnist/v0", batch_size=args.batch_size,image_size=28)
